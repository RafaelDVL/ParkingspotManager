package com.rafaelproject.parkingspot.controllers;


import com.rafaelproject.parkingspot.dtos.ParkingSpotDTO;
import com.rafaelproject.parkingspot.model.ParkingSpotModel;
import com.rafaelproject.parkingspot.services.ParkingSpotService;
...
public class ParkingSpotController {
    ...
    public ResponseEntity<Object> saveParkingSpot(@RequestBody @Valid ParkingSpotDTO parkingSpotDTO){
        ...
        if(parkingSpotService.existsByParkingSpotNumber(parkingSpotDTO.getParkingSpotNumber())){
            return ResponseEntity.status(HttpStatus.CONFLICT).body("Conflict: Number Parking Spot is already in use");
        }
